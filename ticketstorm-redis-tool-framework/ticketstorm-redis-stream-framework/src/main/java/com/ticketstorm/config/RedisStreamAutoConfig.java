...
import com.ticketstorm.RedisStreamConfigProperties;
import com.ticketstorm.RedisStreamHandler;
import com.ticketstorm.RedisStreamListener;
import com.ticketstorm.RedisStreamPushHandler;
import com.ticketstorm.constant.RedisStreamConstant;
...
public class RedisStreamAutoConfig {
    ...
    public void checkConsumerType(String consumerType){
        if ((!RedisStreamConstant.GROUP.equals(consumerType)) && (!RedisStreamConstant.BROADCAST.equals(consumerType))) {
            throw new TicketStormFrameException(BaseCode.REDIS_STREAM_CONSUMER_TYPE_NOT_EXIST);
        }
    }
}
