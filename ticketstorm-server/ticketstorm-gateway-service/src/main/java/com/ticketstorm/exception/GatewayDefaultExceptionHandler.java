...
public class GatewayDefaultExceptionHandler implements ErrorWebExceptionHandler {
    ...
    public Mono<Void> handle(ServerWebExchange exchange, Throwable ex) {
        ...
        }else if (ex instanceof TicketStormFrameException) {
            TicketStormFrameException ticketStormFrameException = (TicketStormFrameException)ex;
            ApiResponse<String> apiResponse = ApiResponse.error(ticketStormFrameException.getCode(), ticketStormFrameException.getMessage());
