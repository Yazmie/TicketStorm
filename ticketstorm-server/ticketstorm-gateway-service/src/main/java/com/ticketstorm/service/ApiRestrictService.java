...
import com.ticketstorm.enums.ApiRuleType;
import com.ticketstorm.enums.BaseCode;
import com.ticketstorm.enums.RuleTimeUnit;
import com.ticketstorm.exception.TicketStormFrameException;
import com.ticketstorm.kafka.ApiDataMessageSend;
...
import com.ticketstorm.service.lua.ApiRestrictCacheOperate;
import com.ticketstorm.util.DateUtils;
import com.ticketstorm.vo.DepthRuleVo;
    ...
    public void apiRestrict(String id, String url, ServerHttpRequest request) {
        if (checkApiRestrict(url)) {
            ...
            if (triggerResult == 1) {
                ...
                throw new TicketStormFrameException(BaseCode.API_RULE_TRIGGER.getCode(),defaultMessage);
            }
        }
    }
