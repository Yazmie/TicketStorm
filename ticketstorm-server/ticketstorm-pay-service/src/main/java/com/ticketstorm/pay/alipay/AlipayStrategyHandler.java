package com.ticketstorm.pay.alipay;
...
import com.ticketstorm.enums.AlipayTradeStatus;
...
import com.ticketstorm.pay.alipay.config.AlipayProperties;
...
public class AlipayStrategyHandler implements PayStrategyHandler {
    ...
    public PayResult pay(String outTradeNo, BigDecimal price, String subject, String notifyUrl, String returnUrl){
        try {
           ...
           throw new TicketStormFrameException(BaseCode.PAY_ERROR);
        }
    }
    ...
    public RefundResult refund(String outTradeNo, BigDecimal price, String reason) {
        ...
        try {
            ...
            throw new TicketStormFrameException(BaseCode.REFUND_ERROR);
        }
    }
    ...
    private Integer convertPayBillStatus(String tradeStatus){
        ...
        throw new TicketStormFrameException(BaseCode.ALIPAY_TRADE_STATUS_NOT_EXIST);
    }
}
