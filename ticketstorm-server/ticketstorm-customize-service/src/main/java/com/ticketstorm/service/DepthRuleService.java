...
import com.ticketstorm.dto.DepthRuleDto;
import com.ticketstorm.dto.DepthRuleStatusDto;
import com.ticketstorm.dto.DepthRuleUpdateDto;
    ...
    public void check(String startTimeWindow, String endTimeWindow){
        ...
        for (final DepthRule depthRule : depthRules) {
            ...
            if (checkStartLimitTimeResult || checkEndLimitTimeResult) {
                throw new TicketStormFrameException(BaseCode.API_RULE_TIME_WINDOW_INTERSECT);
            }
        }
    }
