package com.ticketstorm.core;

import com.ticketstorm.servicelock.LockType;
import com.ticketstorm.servicelock.ServiceLocker;
import com.ticketstorm.servicelock.impl.RedissonFairLocker;
import com.ticketstorm.servicelock.impl.RedissonReadLocker;
import com.ticketstorm.servicelock.impl.RedissonReentrantLocker;
import com.ticketstorm.servicelock.impl.RedissonWriteLocker;
import org.redisson.api.RedissonClient;

import java.util.HashMap;
import java.util.Map;

import static com.ticketstorm.servicelock.LockType.Fair;
import static com.ticketstorm.servicelock.LockType.Read;
import static com.ticketstorm.servicelock.LockType.Reentrant;
import static com.ticketstorm.servicelock.LockType.Write;
