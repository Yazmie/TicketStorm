package com.ticketstorm.filter.impl;
...
import static com.ticketstorm.constant.Constant.GRAY_FLAG_FALSE;
import static com.ticketstorm.constant.Constant.GRAY_FLAG_TRUE;
        ...
        try {
            ...
            if (!result && grayFromRequest.equalsIgnoreCase(GRAY_FLAG_TRUE)) {
                if (CollectionUtil.isEmpty(servers)) {
                    throw new TicketStormFrameException(BaseCode.SERVER_LIST_NOT_EXIST);
                }
